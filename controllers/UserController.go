...
func (c *UserController) Index() {
	...
	if totalCount > 0 {
		html := utils.NewPaginations(common.RollPage, totalCount, pageSize, page, web.URLFor("UserController.Index", ":username", c.UcenterMember.Account), "")
...
func (c *UserController) Collection() {
	...
	if totalCount > 0 {
		html := utils.NewPaginations(common.RollPage, int(totalCount), pageSize, page, web.URLFor("UserController.Collection", ":username", c.UcenterMember.Account), "")
		c.Data["PageHtml"] = html
	} else {
		c.Data["PageHtml"] = ""
	}
...
func (c *UserController) Follow() {
	...
	if totalCount > 0 {
		html := utils.NewPaginations(common.RollPage, int(totalCount), pageSize, page, web.URLFor("UserController.Follow", ":username", c.UcenterMember.Account), "")
		c.Data["PageHtml"] = html
	} else {
		c.Data["PageHtml"] = ""
	}
...
func (c *UserController) Fans() {
	...
	if totalCount > 0 {
		html := utils.NewPaginations(common.RollPage, int(totalCount), pageSize, page, web.URLFor("UserController.Fans", ":username", c.UcenterMember.Account), "")
		c.Data["PageHtml"] = html
	} else {
		c.Data["PageHtml"] = ""
	}
